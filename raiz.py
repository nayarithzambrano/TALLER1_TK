...
titulo = Label(frame_entrada, text="Raiz X de un numero N")
titulo.config(bg="yellow", fg="blue", font=("Arial", 16))
titulo.place(x=240, y=10)


# Etiqueta para el subtitulo2 de la app
subtitulo2 = Label(frame_entrada, text="Hallar la raiz X de un numero enesimo,\n")
...
etiq_a = Label(frame_entrada, text="valor del indice (x): = ")
...
bt_sum = PhotoImage(file="sumar3.png")
...
bt_bor = PhotoImage(file="boton_papel.png")
...
bt_sal = PhotoImage(file="boton_salida.png")
