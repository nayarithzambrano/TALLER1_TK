...
def sumar():
    ...
    t_resultados.insert(INSERT,"Resultados:\n El numero"+str(x)+"a la invercion es "+str(z)+"\n")
...
titulo = Label(frame_entrada, text="ORDEN INVERSO")
titulo.config(bg="cyan", fg="blue", font=("Arial", 16))
...
subtitulo2 = Label(frame_entrada, text="SUMA DE LOS PRIMEROS 4 DIGITOS")
subtitulo2.config(bg="ivory2", fg="blue", font=("Arial", 15), anchor=CENTER)
subtitulo2.place(x=390, y=70)

# imagen - logo de la app
logo = PhotoImage(file="numeros.png")
etiq_logo = Label(frame_entrada, image=logo)
etiq_logo.place(x=10,y=10)

# etiqueta para valor a
etiq_a = Label(frame_entrada, text="numero de 4 digitos = ")
...
bt_sum = PhotoImage(file="sumas.png")
...
bt_sal = PhotoImage(file="boton_sali.png")
